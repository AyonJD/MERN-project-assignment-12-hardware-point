...
const MyOrder = () => {
    ...
    const { data: orders, isLoading, refetch } = useQuery('orders', () => fetch(`https://hardware-server.up.railway.app/orders/${email}`, {
        method: 'GET',
        headers: {
    ...
    const orderDelete = (id) => {
        ...
        fetch(`https://hardware-server.up.railway.app/orders/${id}`, {
            method: 'DELETE',
            headers: {
